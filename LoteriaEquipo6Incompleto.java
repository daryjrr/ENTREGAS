...
public class LoteriaEquipo6 {	
	...
	public static void compruebaDecimos(String[] numerosSorteo, String[] premiosSorteo) throws GordoException{
		...
		System.out.println("Introduce tu decimo de 5 dígitos (introduce 'fin' para terminar)");
		miDecimo=sc.next();
		...
		if (numeroValido) {
			...
			System.out.println("Has sido agraciado con " +miPremio);
	...
	public static void main(String[] args) {
		...
		} 	//COMPLETAR (capturar excepción propia) DFR
		catch (GordoException e) {
			System.out.println("\n¡¡A celebrar, te ha tocado el gordo!!");
		}
		catch (Exception e) {
